            ...
            <div class="card card-primary">
              ...
              <?php
                  ...
                  if(isset($_POST['btnCContato'])){
                      ...
                      $extensao = pathinfo($_FILES['foto']['name'], PATHINFO_EXTENSION); //"pathinfo" extrai a extensão do arquivo, no caso arquivos de foto.

                      //essa condição vai analisar a extensão do arquivo e verificar se está entre as entesões da variavel $formatP.
                      if(in_array($extensao, $formatP)){
                        $pasta = "img/Contato/";  //criar um caminho para armazenar todas as fotos nesta pasta.
                        $temporario = $_FILES['foto']['tmp_name']; //vai procurar onde está a imagem no meu PC e vai futuramente levar para a pasta q defini.
                        $novoNome = uniqid().".$extensao"; //uniqid vai transformar o nome da imagem em código menos o extensão.

                        //mover o arquivo para a pasta definida com um novo nome.
