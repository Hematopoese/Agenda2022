    ...
    <div class="card-body register-card-body">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-6">
            <button style="margin: 0 0 20px 0;" type="submit" name="btnfrezza" class="btn btn-primary btn-block">Registrar</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      <?php
                  include_once('config/conexao3.php');
                  if(isset($_POST['btnfrezza'])){
                      $nome = $_POST['nome'];
                      ...
                      if(move_uploaded_file($temporario, $pasta.$novoNome)){
                        ...
                        $cadastro = "INSERT INTO tbUser (nomeUser,senhaUser,emailUser,fotoUser) VALUES (:nome, :senha, :email, :foto)";
                        try{
