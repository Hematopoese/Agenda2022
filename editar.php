            ...
            <div class="card card-primary">
                ...
                try{
                    ...
                    if($contar>0){
                        while($show = $resultSel->FETCH(PDO::FETCH_OBJ)){
                            ...
                            $nome = $show->nomeContato;
                            $telefone = $show->telefoneContato;
                            $email = $show->emailContato;
                            $foto = $show->fotoContato;
                        }  
                    }else{
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input name="nome" type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $nome; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Telefone</label>
                    <input name="telefone" type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $telefone; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Endereço de E-mail</label>
                    <input name="email" type="email" class="form-control" id="exampleInputEmail1" value="<?php echo $email; ?>">
                  </div>
              ...
              <?php
                  ...
                  if(isset($_POST['btnUpContato'])){
                      ...
                      $editar = "UPDATE tbContato SET nomeContato=:nome,telefoneContato=
                      :telefone,emailContato=:email,fotoContato=:foto WHERE 
                      idContato=:id";
                      try{
          ...
          <div class="col-md-7">
            <div class="card card-primary">
              <div class="card-body p-0" style="text-align:center;">
                <img style="width:150px; border-radius:100%;margin-top:100px" src="img/Contato/<?php echo $foto; ?>">
                <h1><?php echo $nome; ?></h1>
                <h2><?php echo $telefone; ?></h2>
                <h4 style="margin-bottom:110px"><?php echo $email; ?></h4>
              </div>
              <!-- /.card-body -->
            </div>
          </div>
